...
# canvas variables
width = 500 # adjust for width of canvas
height = 500 # adjust for height of canvas
...
pygame.display.set_caption("test sword") # add a caption for your canvas
...
total_sprites = 3 # code the number of sprite images your sprite sheet has
